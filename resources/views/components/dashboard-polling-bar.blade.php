<div class="flex flex-wrap items-center gap-3 rounded-3xl border border-[#E8DCCB] bg-[#FFF9F1] px-5 py-4 text-sm font-bold text-neutral-600 shadow-[0_14px_34px_rgba(24,21,18,0.06)]">
    <span class="flex items-center gap-2">
        <span class="h-2.5 w-2.5 rounded-full" :class="isRefreshing ? 'bg-amber-500' : 'bg-green-500'"></span>
    ...
    <button
        ...
        class="inline-flex items-center rounded-full border border-[#E8DCCB] bg-white px-3 py-1.5 text-xs font-bold text-neutral-700 transition hover:border-[#FF6626]/40 hover:text-[#FF6626] disabled:cursor-wait disabled:opacity-60 sm:ml-auto"
